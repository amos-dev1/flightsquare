...
DELETE FROM public.flight_charges
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.fuel_credits
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.ledger_adjustments
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.member_aircraft_rates
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.aircraft_rates
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
...
DELETE FROM public.reservations
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.blackouts
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.member_aircraft_authorizations
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.compliance_records
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.squawk_deferrals
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.squawks
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
...
DELETE FROM public.meter_readings
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
DELETE FROM public.aircraft_config
 WHERE tenant_id IN ('01920000-0000-7000-8000-00000000000a',
                     '01920000-0000-7000-8000-00000000000b',
                     '01920000-0000-7000-8000-00000000000c');
